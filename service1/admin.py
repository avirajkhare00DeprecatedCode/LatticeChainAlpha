...
from service1.models import UserDetails, CryptoBasket, CryptoCoins, ERC20Tokens, AllocationObject, NewCryptoBasket, CryptoCoinsNew, HistoricalBasketData
...
admin.site.register(HistoricalBasketData)